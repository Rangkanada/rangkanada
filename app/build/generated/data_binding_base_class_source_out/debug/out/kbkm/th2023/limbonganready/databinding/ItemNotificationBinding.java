...
public final class ItemNotificationBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView teksNotif;

  private ItemNotificationBinding(@NonNull CardView rootView, @NonNull TextView teksNotif) {
    this.rootView = rootView;
    this.teksNotif = teksNotif;
  }
  ...
  public static ItemNotificationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.teksNotif;
      TextView teksNotif = ViewBindings.findChildViewById(rootView, id);
      if (teksNotif == null) {
        break missingId;
      }

      return new ItemNotificationBinding((CardView) rootView, teksNotif);
    }
